...
Tests run in CI with link:.github/workflows[Github Actions]. Some commands can be found there to help you with testing your changes before pushing them to a topic branch.
